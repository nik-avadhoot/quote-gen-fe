...
// ── Engine & Data ─────────────────────────────────────────────────────────
import { PLANTS, BOX_TYPES, DEFAULT_BOX_TRIM_DATA, INIT_SPEC } from "./data/defaults.js";
...
function QuotationApp(){
  ...
  const {
    ...
    batchConstrTargetRowId, batchProfile, batchResults, batchRows, boxTrim, calculateAll, card, clTabExpandedConstr, clTabFilter,
    clTabQuery, compliance, constructionLib, costingContext, effectiveFrom, effectiveTo,
    expandedRows, freight, generateCode, generateMissingCodes,
    getBatchRowStatus, gradeCodes, handleBackup, handleRestore,
    ...
    marginSugg, missing, newSector, osSaving, partitionsMaster,
    pinnedAddOns, pushCostingToBatchRow, quoteDate, quoteRef, r, rates,
    ...
    setBatchProfile, setBatchResults, setBatchRows, setBoxTrim, setClTabExpandedConstr, setClTabFilter, setClTabQuery, setConstructionLib,
    setCostingContext, setEffectiveFrom, setEffectiveTo, setExpandedRows, setItems, setNewSector, setPartitionsMaster, setQuoteDate, setQuoteRef, setSavedQuotes, setSectors, setSetAutoFill, setShowChangePassword, setShowProfile,
