...
function QuotationApp(){
  ...
  const {
    ...
    batchConstrTargetRowId, batchProfile, batchResults, batchRows, calculateAll, card, compliance, constructionLib, costingContext, effectiveFrom, effectiveTo,
    ...
    setBatchProfile, setBatchResults, setBatchRows, setCostingContext, setEffectiveFrom, setEffectiveTo, setExpandedRows, setItems, setQuoteDate, setQuoteRef, setSavedQuotes, setSetAutoFill, setShowChangePassword, setShowProfile,
