...
function QuotationApp(){
  ...
  const {
    ...
    batchConstrTargetRowId, batchProfile, batchResults, batchRows, calculateAll, card, compliance, constructionLib, costingContext, expandedRows, freight, generateCode, generateMissingCodes,
    getBatchRowStatus, gradeCodes, handleBackup, handleRestore,
    handleRestoreFile, importConstrFromSpec, invalidateAllBatchResults,
    invalidateBatchRow, items, loadBatchRowIntoCosting, locations, marginSugg, missing, osSaving, partitionsMaster,
    pinnedAddOns, pushCostingToBatchRow, r, restoreAutosave, restoreRef, role, s, sectorCodes, sectors,
