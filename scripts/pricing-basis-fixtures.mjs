...
check(profileBar.includes("Commercials (including Terms)")
  ...
  && profileBar.includes("statusTone={_termOverrideCount?\"warning\":\"neutral\"}")
  ...
  "U4-FE-13 commercial Terms collapse to one summary line and retain all three guarded controls on expansion")
